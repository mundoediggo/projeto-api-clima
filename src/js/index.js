const chaveDeApi = "9c7dd2ac5e78477ba25193614240711";
...
async function buscarDadosDeClima(cidade) {
    const apiUrl = `https://api.weatherapi.com/v1/current.json?key=9c7dd2ac5e78477ba25193614240711&q=London&aqi=no&lang=pt`;
